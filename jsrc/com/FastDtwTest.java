...
public class FastDtwTest
{
    ...
    */
      public static void main(String[] args)
      {
         if (args.length != 3)
         {
            System.out.println("USAGE:  java FastDtwTest timeSeries1 timeSeries2 radius");
            System.exit(1);
         }
         else
         {
            ...
            final TimeWarpInfo info = com.dtw.FastDTW.getWarpInfoBetween(tsI, tsJ, Integer.parseInt(args[2]));
