...
public class TimeSeries
{
   ...
   public TimeSeries(int numOfDimensions)                                               
   {
    ...
    // Explicit constructor (for Clojure connection)
    public TimeSeries(ArrayList inLabels, ArrayList inTimeReadings, ArrayList inTsArray)
    {
	labels = new ArrayList(inLabels);
	timeReadings = new ArrayList(inTimeReadings);
	tsArray = new ArrayList(inTsArray);
    }
